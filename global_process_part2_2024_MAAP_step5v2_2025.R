...
source(s3_get(paste(f.path,"vl_GEDI-PA_2024/matching_func_2025.R",sep="")))
...
##    }
    ...
    saveRDS(iso_matched_gedi, file=paste("output/WDPA_extract/",iso3,"_wk",gediwk,"/",iso3,"_pa_", id_pa,"_gedi_wk_",gediwk,"_conti_",continent,"_lc_",landcover,".RDS", sep=""))
